...
namespace TerminalQuest.Saves
{
    ...
    internal sealed class SaveStore
    {
        ...
        public void WriteOptions(OptionsFile file) => Write(OptionsFileName, file, SaveJsonContext.Readable.OptionsFile);

        public void ClearOptions() => WriteOptions(new OptionsFile { Turn = CurrentTurn(), Options = [] });
